                    ...
                    <TiltCard className="p-8 h-full bg-[#0a0a0a]">
                        ...
                        <div className="space-y-8">
                            <div className="flex items-start gap-5">
                                ...
                                <div>
                                    ...
                                    <p className="text-lg text-white font-medium">contact@raghav.dev</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-5">
                                ...
                                <div>
                                    ...
                                    <p className="text-lg text-white font-medium">+91 98765 43210</p>
                                </div>
                            </div>
                        ...
                        <div className="mt-12 p-6 bg-[#111] rounded-xl border border-white/5 relative overflow-hidden">
                            ...
                            <p className="text-slate-300 italic relative z-10">
                                "I'm currently accepting new freelance projects for Q4 2024. Let's discuss your requirements."
                            </p>
                        </div>
                    </TiltCard>
                </FadeIn>
